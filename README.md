...
**weatherApp** Is a web application that displays list of countries from the  api ( https://public.opendatasoft.com/explore/dataset/geonames-all-cities-with-a-population-1000/api/?disjunctive.cou_name_en&sort=name.)

The goal of this project is to display the ability to display weather related a specific city
...
## note before running this project install and run the tailwindcss and react-router-dom
